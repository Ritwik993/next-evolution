        ...
        <div className="parentContainer relative bg-[#070E18] bg-[url('/a1.png')] w-[100vw]  flex flex-col items-center justify-center z-[-400] overflow-x-hidden">
            <div className="w-full flex-1 relative pb-[100px] overflow-x-hidden">
             ...
             <div className="flex flex-col justify-center items-center w-[100vw] z-50 mt-[100px]">
                ...
                <button className="bg-gradient-to-r from-[#FF6A33] to-[#FF4C0A] py-[12px] px-[24px] rounded-[8px] text-white my-[40px] cursor-pointer z-50 w-4/5 md:w-auto">Pre-order now</button>
            </div>
            </div>
            ...
            <div className="bottomContainer  flex flex-col items-center justify-center w-[100vw] h-full flex-1 relative  z-[-100]  ">
                <div className="bg-[#FF7733] absolute  bg-opacity-60 w-[700px] h-[600px]  rounded-full lg:mb-[600px] md:mb-[600px]  mb-[500px] blur-2xl backdrop-blur-2xl opacity-40 z-[-200]"></div>
            ...
            <div className="w-full flex items-center justify-center z-[100000]">
             <button className="bg-gradient-to-r from-[#FF6A33] to-[#FF4C0A] py-[12px] px-[24px] rounded-[8px] text-white mb-[40px] w-4/5 md:w-auto z-[100000000] cursor-pointer">Pre-order now</button>
            </div> 
                </div>
                </div>
